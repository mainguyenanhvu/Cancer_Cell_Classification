...
callbacks = [
    ...
    ModelCheckpoint('./weight/XXIII-3-200-reseg6_weights.{epoch:02d}-{val_loss:.2f}.hdf5', monitor='val_loss', save_best_only=True, verbose=2)
    ,CSVLogger('./log/XXIII-3-200-reseg6-log.csv',append=False, separator=',')
    # ,TensorBoardWrapper(int_val_generator, nb_steps=math.ceil(nb_validation_samples / batch_size), log_dir='./tf-log-XVII-rg6/',
    #                    histogram_freq=5,
