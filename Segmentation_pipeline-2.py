...
from Segmentation_pipeline_helper_2 import find, watershed_lab, watershed_lab2, resize_pad, find_border, pixel_norm, shift_center_mass
...
imageoutput = "training_seg_5"
#imageoutput = "ext_validation_seg_5"
